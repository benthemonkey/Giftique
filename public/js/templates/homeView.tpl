<div class="landing">
	<div class="text-center" style="margin-top: 1%">
		<div><img src="https://raw.githubusercontent.com/benthemonkey/Giftique/master/public/img/giftiqueme-logo-white-shadow.png" style="width: 30%; min-width: 200px; margin: 20px 0;" /></div>
		<div class="row-fluid">
